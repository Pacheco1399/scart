                ...
                <div class="col-12 col-md-7 col-xl-7">
                    <div class="row col-md-12 col-xl-12">
                        ...
                        <div class="col-1 col-md-1 col-xl-1">
                            <i class="vc-time-icon far fa-clock"></i>

                        </div>
                        <div class="col-5 col-md-2 col-xl-2">


                            <label class="vc-time-text">Quedan 2 hrs</label>
                    ...
                    <label class="vc-card-subtitle">Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                        Massa
                        tellus, tortor tempus purus. Viverra tincidunt posuere turpis pretium. Sagittis
                        pellentesque
