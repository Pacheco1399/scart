            ...
            <div class="carousel1__contenedor">
                <div class="container-fluid">
                    <div class="row row-cols-auto row-cols-1 row-cols-md-auto mb-3">
                        <div class="col">
                            <h2 class="text-primary-scart gradient-text lh-sm mb-0 landing-title sm">Mejores ofertas para mujeres</h2>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="carousel1__lista pt-2 pb-1" data-slides-per-page="2"
                            ...
                            <div class="product-card">
                                ...
                                <div class="header-product-card ">
                                    <img class="img-product-card" src="../../assets/img/13.png" alt="">
                                ...
                                <div class="footer-product-card">
                                    ...
                                    <div class=" description-product-card ">
                                        ...
                                        <p class="title-product-card"> Abrigo Pelos Desmontables </p>
                            ...
                            <div class="product-card">
                                ...
                                <div class="header-product-card ">
                                    <img class="img-product-card" src="../../assets/img/14.png" alt="">
                                    <div class="buttons-product-card">
                                ...
                                <div class="footer-product-card">
                                    ...
                                    <div class=" description-product-card ">
                                        <p class="subtitle-product-card"> ABCDIN </p>
                                        <p class="title-product-card"> Chaqueta Bonded Mujer </p>
                            ...
                            <div class="product-card">
                                ...
                                <div class="header-product-card ">
                                    <img class="img-product-card" src="../../assets/img/15.png" alt="">
                                ...
                                <div class="footer-product-card">
                                    ...
                                    <div class=" description-product-card ">
                                        <p class="subtitle-product-card"> ABCDIN </p>
                                        <p class="title-product-card"> Abrigo mujer </p>
                            ...
                            <div class="product-card">
                                ...
                                <div class="header-product-card ">
                                    <img class="img-product-card" src="../../assets/img/16.png" alt="">
                                    <div class="buttons-product-card">
                                ...
                                <div class="footer-product-card">
                                    ...
                                    <div class=" description-product-card ">
                                        <p class="subtitle-product-card"> ABCDIN </p>
                                        <p class="title-product-card"> Chaqueta Ecocuero Mujer. </p>
